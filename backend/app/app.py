...
from backend.app.routes.student_route import router as student_router
from backend.app.routes.course_route import router as course_router
from backend.app.routes.auth import router as auth_router
from backend.app.routes.eladcampus import router as eladcampus_router
from backend.app.routes.question_route import router as question_router
from backend.app.routes.update_course import router as update_course_router
...
app.include_router(update_course_router)
